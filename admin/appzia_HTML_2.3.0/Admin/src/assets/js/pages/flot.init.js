...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var pcolors = ['#f0f1f4', '#5664d2', '#1cbb8c'];
          ...
          var datas = [20,30, 15];
          var colors = ['#5664d2','#1cbb8c', "#ebeff2"];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#1cbb8c']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ['#f0f1f4', '#5664d2', '#1cbb8c'];
